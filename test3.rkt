...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname test3) (read-case-sensitive #t) (teachpacks ((lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
(require 2htdp/image)
...
(define (tick p x y)
  (make-player (add (player-pos p) (add (player-vel p) (player-acl p))) (maxv (add (player-vel p) (player-acl p)) 10) (towards (player-pos p) (make-posn x y)) (player-color p)))
...
(define (addmore g key)
  (cond [(string=? key "a") (cons (make-player (make-posn (/ BW 2) (/ BH 2)) (make-posn 1 1) (make-posn 0 0) (random 5)) g)]
        [else g]))
(big-bang GAME
  [to-draw dunpack]
  [on-mouse physs]
